...
2. **A MAC address, which are not included in EXCLUDE_MACS property of the config.txt file, and has asked for the MAC of the computer where is installed the BCAST_IDS, using ARP, IPv4 or IPv6 protocols.**
