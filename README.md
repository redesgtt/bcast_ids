...
1. Last but not least, if you want to receive an alert when an anomaly is detected through **Telegram**, you have to follow the following steps:
   ...
   - You can type the /help command to view all the possibilities which you can do with BotFather. Since we want to create a bot, write “/newbot” and follow the instructions:   
